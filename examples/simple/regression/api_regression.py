...
def run_regression_example():
    ...
    composer_params = {'history_folder': 'custom_history_folder', 'preset': 'auto', 'with_tuning': False}
    auto_model = Fedot(problem=problem, seed=42, timeout=5, logging_level=logging.INFO,
                       **composer_params)
