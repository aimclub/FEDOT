...
from examples.simple.classification.classification_pipelines import classification_with_regression_pipeline
...
if __name__ == '__main__':
    run_classification_tuning_experiment(pipeline=classification_with_regression_pipeline(),
                                         tuner=PipelineTuner)
