...
def run_classification_multiobj_example(visualization=False, timeout:float = 1., n_jobs: int = -1, with_tuning=True):
    ...
    auto_model = Fedot(problem=problem, timeout=timeout, preset='best_quality', seed=42,
                       n_jobs=n_jobs, metric=metric_names, with_tuning=with_tuning)
