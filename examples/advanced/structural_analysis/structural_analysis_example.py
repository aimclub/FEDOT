...
from golem.core.dag.verification_rules import has_one_root, has_no_self_cycled_nodes, \
...
class SAObjective(Objective):
    """ Objective for SA. In __call__ method pipeline must be fitted and only then evaluated. """
    def __init__(self,
                 objective: Callable,
...
def set_up() -> Tuple[PipelineOptNodeFactory, SAObjective]:
...
if __name__ == '__main__':
    ...
    print(f'FINAL METRIC: {objective(optimized_pipeline)}')
