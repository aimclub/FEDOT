...
def get_scoring_data():
    file_path_train = join('examples', 'real_cases',
                           'data', 'scoring', 'scoring_train.csv')
    full_path_train = join(str(fedot_project_root()), file_path_train)

    # a dataset for a final validation of the composed model
    file_path_test = join('examples', 'real_cases', 'data',
                          'scoring', 'scoring_test.csv')
...
def get_cholesterol_data():
    file_path = join('examples', 'real_cases', 'data',
                     'cholesterol', 'cholesterol.csv')
    full_path = join(str(fedot_project_root()), file_path)
