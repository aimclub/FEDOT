...
def display_roc_auc(pipeline_to_validate, test_dataset, pipeline_name: str):
    roc_auc_metric = calculate_validation_metric(
        pipeline_to_validate, test_dataset)
...
def run_refinement_scoring_example(train_path, test_path, with_tuning=False):
    ...
    if with_tuning:
        ...
        display_roc_auc(no_decompose_c, test_dataset,
                        'Non decomposition pipeline after tuning')
        display_roc_auc(decompose_c, test_dataset,
                        'With decomposition pipeline after tuning')
...
if __name__ == '__main__':
    ...
    run_refinement_scoring_example(
        full_path_train, full_path_test, with_tuning=True)
