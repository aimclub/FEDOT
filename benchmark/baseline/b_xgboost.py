...
def run_xgboost(train_file_path: str, test_file_path: str, target_name: str, task_flag: int):
    ...
    if task_flag == 1:
        ...
        x_train,y_train = train_dataframe.iloc[:,:-1], train_dataframe.iloc[:,-1]
        x_test,y_test = test_dataframe.iloc[:,:-1], test_dataframe.iloc[:,-1]
