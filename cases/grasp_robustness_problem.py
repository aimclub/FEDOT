...
def run_grasp_robustness_problem(dataset_path, max_lead_time: datetime.timedelta = datetime.timedelta(minutes=300),
                                 is_visualise=False):
    ...
    dataset, _ = train_test_data_setup(dataset, split_ratio=0.05)
    ...
    composer_requirements = GPComposerRequirements(
        ...
        max_depth=3, pop_size=20, num_of_generations=100,
