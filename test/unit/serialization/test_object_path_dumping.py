...
DUMPING_CASES = [
    ...
    DumpObjectTestCase(
        ...
        test_answer={
            CLASS_PATH_KEY: f'{TEST_MODULE_PATH}{DELIMITER}TestEnum'
        }
    ),
    DumpObjectTestCase(
        test_input=test_func,
        test_answer={
            CLASS_PATH_KEY: f'{TEST_MODULE_PATH}{DELIMITER}test_func'
        }
    ),
    DumpObjectTestCase(
        test_input=TestClass().test_func,
        test_answer={
            CLASS_PATH_KEY: f'{TEST_MODULE_PATH}{DELIMITER}TestClass.test_func'
        }
    ),
    DumpObjectTestCase(
        test_input=TestSerializableClass(),
        test_answer={
            CLASS_PATH_KEY: f'{TEST_MODULE_PATH}{DELIMITER}TestSerializableClass'
        }
    )
]
