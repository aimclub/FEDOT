...
def test_classification_models_fit_correct(data_fixture, request):
    ...
    for model_name in model_names:
        ...
        _, train_predicted = model.fit(params='default_params', data=train_data)
...
def test_log_clustering_fit_correct(data_fixture, request):
    ...
    _, train_predicted = kmeans.fit(params='default_params', data=scaled_data)
...
def test_svc_fit_correct(data_fixture, request):
    ...
    _, train_predicted = svc.fit(params='default_params', data=scaled_data)
...
def test_pca_model_removes_redunant_features_correct():
    ...
    _, train_predicted = pca.fit(params='default_params', data=scaled_data)
