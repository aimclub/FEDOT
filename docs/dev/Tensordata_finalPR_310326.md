...
Этот PR завершает первый большой вертикальный срез TensorData-first refactoring и доводит `fedot/industrial` до совместимого состояния с новой архитектурной линией.
