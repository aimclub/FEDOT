...
.. csv-table:: Available models definitions
   ...
   `bagreg`, Random Subsets Learning,Regression
   ...
   `bagging`, Random Subsets Learning,Classification
...
.. csv-table:: Available models implementations
   ...
   `bagreg`, `sklearn.ensemble.BaggingRegressor`, `*tree`
   ...
   `bagging`, `sklearn.ensemble.BaggingClassifier`, `*tree`
