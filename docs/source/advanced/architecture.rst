...
* InputData with DataPreprocessor (see :py:class:`~fedot.core.data.input_data.data.InputData` and :doc:`data_preprocessing`), that handle data loading from various formats & preprocessing of the data for ML operations.
