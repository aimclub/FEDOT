...
from fedot.api.api_utils.assumptions_builder import TaskAssumptions
...
class ApiInitialAssumptionsLegacy(ApiInitialAssumptions):
    ...
    def create_unidata_pipelines(self,
        ...
        return TaskAssumptions.for_task(task).processing_pipelines(node_prepocessed)
