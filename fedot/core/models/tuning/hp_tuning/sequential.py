...
from fedot.core.models.tuning.hp_tuning.hyperparams import get_node_params, convert_params
from fedot.core.data.data import train_test_data_setup
from fedot.core.log import Log
from hyperopt import fmin, tpe, space_eval
from fedot.core.models.tuning.hp_tuning.tuner_interface import HyperoptTuner, _greater_is_better
...
class SequentialTuner(HyperoptTuner):
    ...
    def tune_chain(self, input_data, loss_function, loss_params=None):
        """ Method for hyperparameters sequential hp_tuning """
        ...
        for node_id in nodes_ids:
            ...
            if node_params is None:
                ...
                # Apply hp_tuning for current node
    ...
    def tune_node(self, input_data, loss_function, node_index, loss_params=None):
        """ Method for hyperparameters hp_tuning for particular node"""
        # Train test split
        train_input, predict_input = train_test_data_setup(input_data)
        test_target = np.array(predict_input.target)
