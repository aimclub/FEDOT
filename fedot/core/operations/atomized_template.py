...
class AtomizedOperationTemplate(OperationTemplateAbstract):
    def __init__(self, node: Node = None, operation_id: int = None, nodes_from: list = None, path: str = None):
        ...
        super().__init__()
        self.atomized_operation_json_path = None
        ...
        if path:
            chain = Chain()
            chain.load(path)
            self.next_chain_template = AtomizedOperation(chain)
    ...
    def _operation_to_template(self, node: Node, operation_id: int, nodes_from: list):
        ...
        self.atomized_operation_json_path = 'nested_' + str(self.operation_id)
    ...
    def convert_to_dict(self) -> dict:
        ...
        operation_object = {
            ...
            "atomized_operation_json_path": self.atomized_operation_json_path
        }
    ...
    def export_operation(self, path: str):
        absolute_path = os.path.join(path, self.atomized_operation_json_path)
    ...
    def import_json(self, operation_object: dict):
        required_fields = ['operation_id', 'operation_type', 'nodes_from', 'atomized_operation_json_path']
        ...
        self.atomized_operation_json_path = operation_object['atomized_operation_json_path']
