...
from typing import Any, Callable, Container, Iterable, List, Sequence, Sized, Union
...
def ensure_sequence(obj: Union[Any, Iterable[Any], Sequence[Any]],
                    sequence_type: Callable[[Any], Sequence[Any]] = list) -> Sequence[Any]:
