...
def visualise_fitness_box(history: OptHistory, save_path: Optional[Union[os.PathLike, str]] = None,
    ...
    """
    df_history = get_history_dataframe(history, get_tags=False, best_fraction=best_fraction)
