...
class NodeFactory(ABC):
    ...
    def change_node(self,
        ...
        the node is primary or secondary
    ...
    def change_intermediate_node(self,
        ...
        """Returns new node based on a current node using information weather
        the node is primary or secondary and using
        advisor.propose_change to select candidate changes.

        :param node: current node that must be changed
        :param requirements: requirements for changing the node
        :param advisor: DefaultChangeAdvisor to propose possible change candidates
        """
        pass
