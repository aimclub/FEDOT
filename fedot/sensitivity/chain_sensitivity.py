...
class ChainAnalysis:
    """
    This class is for analyzing the Chain as the black-box model,
    using analysis approaches defined for whole chain perturbation,
    ...
    :param approaches: methods applied to chain \
    ...
    :param path_to_save: path to save results to. Default: ~home/Fedot/sensitivity/chain_sa
    Default: False
    ...
    def __init__(self, chain: Chain, train_data: InputData, test_data: InputData,
        ...
        self.path_to_save = \
            join(default_fedot_data_dir(), 'sensitivity', 'chain_sa') if path_to_save is None else path_to_save

        self.log = default_log(__name__) if log is None else log

    def analyze(self) -> dict:
        """
        Apply defined approaches for the black-box chain analysis
        :return:
        """
