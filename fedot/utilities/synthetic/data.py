...
def classification_dataset(samples_amount: int, features_amount: int,
                           classes_amount: int,
    ...
    """
    features, target = datasets.make_classification(n_samples=samples_amount,
...
def regression_dataset(samples_amount: int, features_amount: int,
                       features_options: Dict,
                       n_targets: int, noise: float = 0.0,
                       shuffle: bool = True):
    """
    ...
    features, target = datasets.make_regression(n_samples=samples_amount,
                                                n_features=features_amount,
                                                n_informative=features_options[
                                                    'informative'],
