...
class ComposerRequirements:
    def __init__(self, primary_requirements, secondary_requirements):
...
class DummyComposer(Composer):
    ...
    def compose_chain(self, initial_chain: Optional[Chain],
        ...
        if self.dummy_chain_type == DummyChainTypeEnum.hierarchical:
            ...
            # (y1) -> (y2) -> y
            first_node = NodeGenerator.get_primary_node(composer_requirements.primary_requirements[0], empty_data)
